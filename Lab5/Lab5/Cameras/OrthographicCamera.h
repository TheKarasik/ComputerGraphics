...
public:
    ...
    DirectX::SimpleMath::Matrix projection_matrix() override {return ortographic_matrix_;}
    DirectX::SimpleMath::Matrix ViewPerspectiveMatrix() const;
    void set_position(DirectX::SimpleMath::Vector3 position) {position_ = position; SetUpMatricies();}
    void set_up_direction(DirectX::SimpleMath::Vector3 up_direction) {up_direction_ = up_direction; SetUpMatricies();}
    void set_direction(DirectX::SimpleMath::Vector3 direction) {direction_ = direction; SetUpMatricies();}
